...
class TestRunpyHierarchy:
    ...
    @allure.title("Given command groups, When accessing subcommands, Then executes correctly")
    ...
    @allure.title("Given nested command groups, When accessing deep commands, Then navigates correctly")
    ...
    @allure.title("Given path configuration, When initializing CLI, Then creates proper structure")
    ...
    @allure.title("Given mixed depth commands, When calling at different levels, Then all work")
